portalOS.prototype.initGui = function ()
{	
...
portalOS.prototype.createTestEnvironment = function()
{
	var gui = this.gui2d;
...
portalOS.prototype.guiCreateSkin = function()
{
	...
	var Font	= g.loadFont ( skinname+'fonts/font00.png',16,16,2);
	...
	wskin.setFont	(  0, { 'font' : Font, 'letterSpacing':4, 'scale':[ .75, .75], 'color':[ 1, 1, 1, 1]} );
	...
	var guiBackground	= g.loadImage (skinname+'images/bg01.jpg',2);
