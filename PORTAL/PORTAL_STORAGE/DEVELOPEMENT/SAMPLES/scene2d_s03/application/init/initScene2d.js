scene2d_s03.prototype.initScene2d = function ()
{	
	...
	var layer0	= scene2d.createLayer(2,1,1024,110);
	...
	var bgImg = graphics2d.loadImage( rootpath +'map/BG/BG.png',1);
	...
	bgTile.scale  =[1.0,1.0];
	bgTile.setAlpha(1);
	
	bgTile.midhandle = false;
	bgTile.color =[0.3,0.4,0.3,1.0];
	...
	this.butterflyImage = graphics2d.loadAnimImage( rootpath +'media/anim02.png',14,6,2);

	var playerImg = graphics2d.loadAnimImage( rootpath +'media/run1.png',10,1,2);
