function init_scene2d()
{	
	var graphics2d = myApp.global.graphics2d;
	var scene2d = new jsaf_scene2d(graphics2d);	
 
	myApp.global.scene2d = scene2d;
	...
	var cam2d	= myApp.global.cam2d = scene2d.createCam();
	
 
 
	var imgPL = graphics2d.loadImage('map/Tiles/13.png',1);
	var imgPC = graphics2d.loadImage('map/Tiles/14.png',1);
	var imgPR = graphics2d.loadImage('map/Tiles/15.png',1);

	var bgImg = graphics2d.loadImage('map/BG/BG4.png',1);
	var img2 = graphics2d.loadImage('map/Tiles/2.png',1);
	var img3 = graphics2d.loadImage('map/Object/Bush1.png',1);
	...
	bush.blendmode = MASK_BLEND;
	bush2.blendmode = MASK_BLEND;

 	ptileL.blendmode = MASK_BLEND;
 	ptileC.blendmode = MASK_BLEND;
 	ptileR.blendmode = MASK_BLEND;
	
	bgTile.blendmode = MASK_BLEND;
	bdTile.blendmode = MASK_BLEND;
	bdTile2.blendmode = MASK_BLEND;
	...
	myApp.global.butterflyImage = graphics2d.loadAnimImage('media/anim02.png',14,6,1);

	var playerImg = graphics2d.loadAnimImage('media/run1.png',10,1,1);
	//var playerImg = graphics2d.loadImage('media/obj01.png');

	var obj = new jsaf_scene2d_object(playerImg);
	obj.blendmode=MASK_BLEND;
	obj.animated=true;
	...
	myApp.global.player = obj;

	myApp.global.layer = [layer0,layer1,layer2,layer3,layer4];
